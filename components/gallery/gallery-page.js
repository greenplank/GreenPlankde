  ...
  return (
    <section className="gallery-page pt-120 pb-120">
      <div className="container">
        <BlockTitle
          title={`Smart Cap Terrassendielen aus WPC
          `}
        />
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Smart Classic Komposit Terrassendielen
          `}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Primacap Komposit Fassadenverkleidung`}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Novofence Komposit Zaun System`}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Novoclad Komposit Fassadenverkleidung `}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Naturplank Komposit Planken - massive 
          `}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Marine Jumbo - massive Terrassendielen aus Komposit 
          `}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Marine Cap Terrassendielen - Solides Profil aus WPC 
          `}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Marine40 Solid Komposit Terrassendielen`}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Ever Deck Terrassendielen mit Hohlkammer aus WPC
          `}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Classic Jumbo Komposit Terrassendielen`}
        />
        <div className="gallery-3-col">
      ...
      <div className="container mt-80">
        <BlockTitle
          title={`Classic Komposit Terrassendielen mit Hohlkammer
          `}
        />
        <div className="gallery-3-col">
