...
const marinejumbokomposittrall = () => {
  return (
    <Layout pageTitle="MARINE JUMBO™">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="MARINE JUMBO™" crumbTitle="MARINE JUMBO™" />
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                        <div className="project-details">
                          <h2>MARINE JUMBO™ Schwerlast Premium Terrassendielen</h2>
                          <strong>zeitlose Eleganz für gehobene Ansprüche – PVC-frei!</strong>
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">

                              <strong>Inspiriert von der Kraft der Natur, gestützt von Beweisen Green Plank MARINE JUMBO™ ist die breiteste reversible Heavy-Duty-Terrassendiele auf dem Markt, die von nordischen Gemeinden verwendet wird. Sie wurde als Holzalternative für extreme nordische Wetterbedingungen gebaut.</strong>
                              <p>
                                Die Hochleistungs-Naturfaser-Terrassendielen von MARINE JUMBO™ wurden speziell für gewerbliche Terrassendielen aus Verbundwerkstoffen entwickelt. Es ist perfekt für stark frequentierte öffentliche Orte wie Themenparks, Stadien, Strandpromenaden, Jachthäfen und Hotels. Seine robuste, barfußfreundliche Oberfläche und sein traditionelles und elegantes Aussehen sorgen für jahrzehntelange, langlebige und wartungsarme Leistung. Mit reversiblen gerippten / gerillten, gebürsteten Oberflächen, verbesserter Rutschfestigkeit und lang anhaltender Leistung ist unser MARINE JUMBO™-WPC Terrassendielen die professionelle Wahl für gewerbliche Projekte.</p>
                              <p>Hochrutschhemmende, gebürstete Rippen- / Rillenoberflächen im europäischen Stil ermöglichen eine gute Traktion in nassen Bereichen wie Pools und Promenaden. Sie sind mit bloßen Füßen begehbar.</p>
                              <p>Wie echte Holzbretter auch unser MARINE JUMBO™ Terrassendielen aus Verbundwerkstoff können in jede gewünschte Form geschliffen oder gesägt werden, ohne dass der Echtholz-Effekt der Terrassendiele verloren geht.</p>
                              <div>
                                <ul>
                                  ...
                                  <li><strong>Ergänzendes Zubehör</strong>–Vervollständigen Sie Ihr Terrassenprojekt mit unseren Blenden und Abdeckungen – die perfekte Ergänzung für Ihre leistungsstarken MARINE JUMBO™ Terrassen.</li>
                                </ul>
                              </div>
                            </div>
                          </div>
                                ...
                                <table width="100%">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td align="left">	Rutschhemmend rAuf der Rückseite mit einem
                                        flachen Finish versehen, tropische Harthölzer; Wendebretter</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td align="left">Ca. 4,40 Meter für 1 m²</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td align="left">60 cm c / c für kommerzielle Anwendungen *</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                      ...
                      <div className="col-12 mb-30 mt-80" >
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="/pdfs/marine-jumbo-german-with-aluminum.pdf">
                              <img src={pdfimg4} className="img-fluid" alt="" />
                            </a>
                          </Grid>
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="/pdfs/datenblatt-marine-jumbo-terrassendiele-wpc-bpc-greenplank.pdf">
