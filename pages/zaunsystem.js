...
const staketsystem = () => {
    return (
        <>
            <Head>
                <title>Zaunsystem | Verbundzaunsystem - GreenPlank.de
</title>
               <link rel="canonical" href="/zaunsystem" />

                <meta name="title" content="Exklusiver Zaun | Moderne Zäune - GreenPlank.de
" />
                <meta name="description" content="Zaunwände werden heute häufig als Grenze verwendet, um Ihren Garten zu umbinden, Ihre Landschaftsstruktur zum Höhepunkt zu bringen oder im Mittelpunkt Ihrer Exposition zu stehen.
" />
            </Head>
            <Layout pageTitle="Zaunsystem | Verbundzaunsystem - GreenPlank.de
">
                <HeaderTwo />
