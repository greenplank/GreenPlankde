...
const InstallationUnderhall = () => {
  return (
    ...
    <link rel="canonical" href="/installation-und-wartung" />
        <meta name="title" content="Installation und Wartung | Hilfe und Anleitungen - GreenPlank.de" />
        <meta name="description" content="Green Plank-Installationsanleitungen und -Videos können Ihnen dabei helfen, Verbundfliesen, Fassadenpaneele, Zäune und Geländer mit Leichtigkeit richtig zu installieren." />
      </Head>
      <Layout pageTitle="Installation und Wartung | Hilfe und Anleitungen - GreenPlank.de">
        <HeaderTwo />
