...
const naturplankkompositplankagp733 = () => {
  return (
    ...
    <meta name="robots" content="index,follow" />
       <link rel="canonical" href="https://www.greenplank.de/naturplank-komposit-tackbrada-gp733-10130mm" />
    ...
    <Layout pageTitle="Naturplank Täckbräda Medium 10*130">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="NATURPLANK™ Composite Plank – GP733" crumbTitle="gp733" />
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                        <div className="project-details">
                          <h2>
                          NATURPLANK™ Composite Plank – GP733 – Die grüne Alternative</h2>
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              ...
                              <p>
                              Green Plank NATURPLANK ™ Hochleistungs-Naturfaser-Verbunddiele GP733 ist ideal für verschiedene Außenanwendungen wie Handläufe, Terrassen-, Terrassen- und Gartenmöbel, Parkbänke, Tische, Mülleimer und Aufbewahrung.
                              </p>
                              <p>
                              ...
                              <p>
                              Unsere NATURPLANK ™ Vierkant-Verbunddielen GP733 können wie echte Holzbretter in jede gewünschte Form geschliffen oder gesägt werden, ohne das Echtholz-Erscheinungsbild der Verbundplatte zu verlieren.
                              </p>
                              <div>
                                <ul>
