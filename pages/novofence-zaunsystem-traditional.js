...
const kompositstakettraditional = () => {
    return (
        <Layout pageTitle="NOVOFENCE™ – Traditional™">
            <HeaderTwo />
            <StickyHeader />
            <PageHeader title="NOVOFENCE™ – Traditional™" crumbTitle="NOVOFENCE™ – Traditional™" />
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 col-12 section-space--bottom--80 pl-30 pl-sm-15 pl-xs-15">
                                                <div className="project-details">
                                                    <h2>NOVOFENCE™ Lattenzaun Querriegel ALU – Traditional™</h2>
                                                    <strong>Guter Nachbarzaun mit Stil und Stärke – PVC frei!</strong>
                                                    <div class="et_pb_text_inner">
                                                        <div class="ce_text block">

                                                            <strong>Ein einfach zu bauender, wartungsfreier, hochwertiger, maßgeschneiderter Zaun, der Ihren spezifischen Anforderungen entspricht. Dieser Stil sieht aus wie ein Sichtschutzzaun, ermöglicht jedoch eine bessere Luftzirkulation.</strong>
                                                            <p>
                                                                Traditional™ – ein idealer guter Nachbarzaun hat auf beiden Seiten das gleiche Aussehen. Das Novofence™ Traditional™ haltbare Shadowbox-Design enthält eine doppelte Reihe von Streikposten aus wartungsarmem Verbundwerkstoff, eine auf jeder Seite horizontaler, verstärkter Zaunschienen (Edelstahl + Verbundwerkstoff), die zwischen den verstärkten Zaunpfosten (Aluminium + Verbundwerkstoff) verlaufen. Die beiden Reihen der zusammengesetzten Streikposten sind versetzt angeordnet, sodass die Abstände zwischen den Streikposten auf der einen Seite der Zaunschienen durch die Streikposten auf der anderen Seite der Schiene blockiert werden. Der Raum zwischen den Reihen lässt Wind durch den Zaun wehen, aber die Sicht durch den Zaun wird von den Streikposten fast vollständig blockiert
                                                            </p>
                                                            <p>
                                                                Der traditionelle Zaunsystem ist eine schöne, einzigartige und wartungsarme Alternative zu Holz- und Vinylzäunen. Unsere Zaunsystem bretter sind kunstvoll so konstruiert, dass sie wie echtes Holz aussehen, ohne geölt, gestrichen oder verstemmt zu werden.
                                                            </p>
                                                            ...
                                                            <div>
                                                                <ul>
                                                                    ...
                                                                    <li><strong>Verstärkte Pfosten und Schienen</strong>–  Hochwertiger, wartungsarmer stabiler Rahmen aus Aluminium + Verbundpfosten und horizontalen Edelstahl + Verbundschienen.</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="col-md-6 col-mobile-6 mb-20">
                                                            <div className="project-information mb-20">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <strong>3.</strong>Zusammengesetzte quadratische Spitze Streikposten
                                                                    </li>
                                                                    <li>
                                                                        <strong>4.</strong>Metallpfosten-Grundplatten
                                                                    </li>
                                                                    <li>
                                                                        <strong>5.</strong>Edelstahl + Verbundschienen
                                                                    </li>
                                                                    <li>
                                                                        <strong>6.</strong>Zaunschienenhalterung mit Doppelösen
                                                            ...
                                                            <div className="project-information mb-20">
                                                                <ul>
                                                                    <li>
                                                                        ...
                                                                        Mit der Schönheit von Holz und der Langlebigkeit von Aluminium + Verbundwerkstoff, Traditional? fence post sleeve ensures lasting durability with low-maintenance.
                                                                    </li>
                                                                    <li>
                                                        ...
                                                        <div className="col-md-6 col-mobile-6 mb-20">
                                                            <div className="project-information mb-20">
                                                                <ul>
                                                                    <li>
                                                                        <strong>Nutzen:</strong>
                                                                        Mit der Attraktivität von Holz und der Langlebigkeit und Festigkeit von Stahl + Verbundwerkstoff Traditional? fence rails make your fence extra strong.
                                                                    </li>
                                                                    <li>
                                                        ...
                                                        <div className="col-md-6 col-mobile-6 mb-20">
                                                            <div className="project-information mb-20">
                                                                <ul>
                                                                    <li>
                                                                        <strong>Nutzen:</strong>
                                                                        Zaunschienenhalterung mit doppelten Ösen machen die Verbindung zwischen Zaunschienen und Pfosten einfach und stark.
                                                                    </li>
                                                                    <li>
                                                        ...
                                                        <div className="col-md-6 col-mobile-6 mb-20">
                                                            <div className="project-information mb-20">
                                                                <ul>
                                                                    <li>
                                                                        <strong>Nutzen:</strong>
                                                                        Dekorative Pfostenkappe für Zaunpfosten aus Verbundwerkstoff und Aluminium.
                                                                        Schützt den Pfosten vor eindringendem Schmutz.
                                                                    </li>
                                                                    <li>
                                                                        <strong>Größe:</strong>ca. 84 * 84 * 10 mm
                                                                    </li>
                                            ...
                                            <div className="col-12 mb-30 mt-40" >
                                                ...
                                                <Grid container spacing={3}>
                                                    ...
                                                    <Grid item xs={6} sm={2}>
                                                        <a target="_blank" href="/pdfs/green-plank-traditional-fence-installation-guide-2019.pdf">
