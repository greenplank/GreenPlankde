...
const sammansatta = () => {
  return (
    <>
     <Head>
       <link rel="canonical" href="/holzdielen-aus-verbundwerkstoff" />
        <meta name="title" content="Was sind Dielen aus Holzverbundwerkstoff? und wie werden sie installiert? - Greenplank.de" />
        <meta name="description" content="In den späten 1990er Jahren begannen Bauherren und Hausbesitzer, die Vorteile von Verbundholzdielen zu erkennen. Verbundholzdielen sind in mehreren Farben erhältlich, sodass Sie schnell einen persönlichen Bereich schaffen können, der auch ökologisch vorteilhaft ist." />
      </Head>
