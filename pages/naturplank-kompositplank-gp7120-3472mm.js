...
const naturplankkompositplankagp7120 = () => {
  return (
    <Layout pageTitle="NATURPLANK™ Bretter -gp7120-3472mm">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="NATURPLANK™ Bretter -gp7120-3472mm" crumbTitle="gp7120" />
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                        <div className="project-details">
                          <h2>
                          NATURPLANK™ Bretter – GP7120 – die grüne Alternative</h2>
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              ...
                              <p>
                              Green Plank NATURPLANK ™ Hochleistungs-Naturfaser-Bretter GP7120 ist ideal für verschiedene Außenanwendungen wie Handläufe, Terrassen-, Terrassen- und Gartenmöbel, Parkbänke, Tische, Mülleimer und Aufbewahrung.
                              </p>
                              <p>
                              ...
                              <p>
                              Unsere NATURPLANK ™ Vierkant-Bretter GP7120 können wie echte Holzbretter in jede gewünschte Form geschliffen oder gesägt werden, ohne das Echtholz-Erscheinungsbild der Verbundplatte zu verlieren.
                              </p>
                              <div>
                                <ul>
                                ...
                                <table width="100%">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td align="left">40 cm c/c for kommerzielle Einrichtungen*</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
