...
const naturplankkompositplankagp7129 = () => {
  return (
    <Layout pageTitle="NATURPLANK ™ Bretter– GP7129 ">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="NATURPLANK ™ Bretter– GP7129 " crumbTitle="gp7129" />
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                                    <div className="project-details">
                                        <h2>NATURPLANK ™ Bretter– GP7129 – die grüne Alternative</h2>
                                        ...
                                        <div class="et_pb_text_inner">
                                            <div class="ce_text block">
                                                ...
                                                <p>
                                                Green Plank NATURPLANK ™ Hochleistungs-Naturfaser-Hochleistungs-Bretter GP7129 ist eine wartungsarme Alternative zu Hartholz. Sie wurde in einer Vielzahl von Umgebungen eingesetzt, darunter Promenaden, Brücken, Küstenstege, öffentliche Parks, Restaurants im Freien, Freizeitbereiche und Schulen und Firmengelände, etc.
                                                </p>
                                                <p>
                                                ...
                                                <p>
                                                Genau wie echte Holzbretter können unsere ungerillten NATURPLANK ™ GP7129-Schwerlast-Terrassendielen / Bretter in jede gewünschte Form geschliffen oder gesägt werden, ohne das Echtholz-Erscheinungsbild der Verbundplatte zu verlieren.
                                                </p>
                                                <div>
                                                    <ul>
                                                        <li><strong>Premium-Qualität</strong> –  Bewährte Dielen in nordischer Qualität für raues Wetter und umweltfreundlichere Lebensweise.</li>
                                                ...
                                                <div className="project-information">
                                                    ...
                                                    <table width="100%">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left"><strong>Abmessenungen:</strong></td>
