...
const trallbrador = () => {
  return (
    <>
     <Head>
       <link rel="canonical" href="/palettenbretter-aus-holzverbund-fur-hausbesitzer" />
        <meta name="title" content="Planken aus Holzverbundwerkstoff (WPC) für Hausbesitzer - Greenplank.de" />
        <meta name="description" content="Holzverbunddielen sind robust und schön. Außerdem sind sie wieder verwendbar und umweltfreundlich. Sie werden aus einer Mischung von Holzmehl, Polymere, Reishülsen und anderen Komponenten hergestellt." />
      </Head>
