...
const Karriar = () => {
  return (
    ...
    <link rel="canonical" href="/karriere" />
        <meta name="title" content="Karriere - GreenPlank.de
" />
        <meta name="description" content="Green Plank ist Schwedens führender Anbieter von umweltfreundlichen Baustoffen. Seit seiner Gründung im Jahr 2004 hat sich das Unternehmen den Ruf erworben, qualitativ hochwertige Bauprodukte zu möglichst niedrigen Preisen anzubieten.
" />
      </Head>
      <Layout pageTitle="Karriere - GreenPlank.de
">
        <HeaderTwo />
        <PageHeader title="Karriere" crumbTitle="Karriere" />
        <StickyHeader />
            ...
            <Row style={{ marginBottom: "4em" }}>
              <Col lg={12}>
                ...
                <div className="mb-30">
                  ...
                  <p className="mb-30 mt-30">Green Plank ist Europas führender Anbieter von umweltfreundlichen Baustoffen. Seit seiner Gründung im Jahr 2004 hat sich das Unternehmen den Ruf erarbeitet, qualitativ hochwertige Baumaterialien zu möglichst niedrigen Preisen anzubieten.</p>
                  <p className="mb-30 mt-30">Green Plank hat seinen Sitz in Malmö, Schweden. Weitere Informationen zu Green Plank finden Sie auf der Website unter http://www.greenplank.eu.</p>
                  ...
                  <strong>1. </strong>Bestehende Kontakte im Gebäude- / Architekturraum.<br />
