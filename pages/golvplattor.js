...
const golvplattor = () => {
    return (
        <>
            <Head>
                <title>Terrassenfliesen </title>
                <meta name="title" content="Terrassenfliesen  och komposit balkongplattor - GreenPlank.se" />
                <meta name="description" content="Terrassenfliesen  och sammansatta balkonger är perfekta för att återskapa utomhusgolv som uteplatser, tak, balkonger och täcka tuffa inomhusgolv." />
            </Head>
