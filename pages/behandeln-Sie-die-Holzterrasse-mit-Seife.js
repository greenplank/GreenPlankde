...
const BehandlaTratrallenMedTval = () => {
  return (
    <>
     <Head>
       <link rel="canonical" href="/behandeln-Sie-die-Holzterrasse-mit-Seife" />
        <meta name="title" content="Wie kann ich das Holzdeck mit Seife behandeln? - Greenplank.de" />
        <meta name="description" content="Komposit-Terrassendielen gibt ein komplettes Aussehen, also müssen Sie ihn vorsichtig verwenden. Werde eingewachsene Haare los, indem du Peelings und Seife verwendest." />
      </Head>
